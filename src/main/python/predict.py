...
for a1 in data2:	
	...
	forecast=forecast.drop(columns=['trend','trend_lower','trend_upper','yhat_lower','yhat_upper','seasonal','seasonal_lower','seasonal_upper','weekly_upper'])
